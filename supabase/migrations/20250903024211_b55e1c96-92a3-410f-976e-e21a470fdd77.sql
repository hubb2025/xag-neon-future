-- Remover todos os triggers e funções problemáticos
...
DROP FUNCTION IF EXISTS create_admin_user_simple();

-- Recriar a função handle_new_user sem depender de user_roles
...
-- Criar o usuário admin diretamente sem triggers
DO $$
DECLARE
  admin_user_id uuid;
...
BEGIN
  ...
  IF admin_user_id IS NULL THEN
    ...
    -- Inserir na tabela auth.users SEM TRIGGER
...
-- Recriar trigger APÓS criar o usuário admin
