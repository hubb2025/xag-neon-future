-- Limpeza completa de todos os triggers e funções
DROP TRIGGER IF EXISTS assign_admin_role_trigger ON profiles CASCADE;
...
-- Criar usuário admin SEM NENHUM TRIGGER ATIVO
DO $$
DECLARE
  admin_user_id uuid;
