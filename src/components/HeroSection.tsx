  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-secondary/30 to-transparent animate-pulse delay-1000"></div>
        <div className="absolute left-1/4 top-0 w-px h-full bg-gradient-to-b from-transparent via-accent/30 to-transparent animate-pulse delay-500"></div>
        <div className="absolute right-1/4 top-0 w-px h-full bg-gradient-to-b from-transparent via-destructive/30 to-transparent animate-pulse delay-1500"></div>
      </div>

      {/* Floating Geometric Shapes */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-4 h-4 border border-primary/40 rotate-45 animate-float"></div>
        <div className="absolute top-40 right-32 w-6 h-6 border border-secondary/40 animate-float delay-1000"></div>
        <div className="absolute bottom-32 left-40 w-3 h-3 bg-accent/30 rotate-45 animate-float delay-500"></div>
        <div className="absolute bottom-20 right-20 w-5 h-5 border border-destructive/40 rotate-12 animate-float delay-1500"></div>
        
        {/* Larger decorative elements */}
        <div className="absolute top-1/3 left-10 w-20 h-20 border border-primary/20 rotate-45 animate-cyber-pulse"></div>
        <div className="absolute bottom-1/3 right-10 w-16 h-16 border border-secondary/20 animate-cyber-pulse delay-1000"></div>
      </div>

      {/* Glowing Orbs */}
      <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-primary/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/3 right-1/3 w-40 h-40 bg-secondary/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 relative">
            ...
            <div className="absolute -top-8 -left-8 w-16 h-16 border-l-2 border-t-2 border-primary/40"></div>
            <div className="absolute -bottom-8 -right-8 w-16 h-16 border-r-2 border-b-2 border-secondary/40"></div>
            
            <div className="space-y-6">
              <div className="relative">
                {/* Animated text glow effect */}
                <div className="absolute inset-0 blur-md">
                  <h1 className="text-5xl md:text-7xl font-cyber font-black leading-tight text-primary/20">
                    DRONES<br />DO<br />FUTURO
                  </h1>
                </div>
                
                <h1 className="text-5xl md:text-7xl font-cyber font-black leading-tight relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/20 to-transparent w-full h-2 animate-cyber-scan"></div>
              </div>

              <div className="relative">
                <div className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-primary via-secondary to-accent opacity-60"></div>
                <p className="text-xl md:text-2xl text-muted-foreground font-tech max-w-2xl pl-8 relative">
                  Descubra a nova era da tecnologia de drones com designs cyberpunk e performance revolucionária.
                  <span className="absolute -right-2 top-0 w-2 h-2 bg-primary animate-ping"></span>
                </p>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 relative">
              <div className="absolute -top-2 -left-2 w-4 h-4 border border-primary/50"></div>
              <Button className="btn-cyber group text-lg px-8 py-4 relative overflow-hidden">
              ...
              <Button variant="outline" className="btn-cyber-red text-lg px-8 py-4 group relative overflow-hidden">
                ...
                <Play className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform relative" />
            ...
            <div className="flex gap-8 pt-4">
              <div className="text-center relative">
                ...
                <div className="text-2xl font-cyber font-bold text-primary relative">50+</div>
                <div className="text-sm text-muted-foreground relative">Modelos</div>
              </div>
              <div className="text-center relative">
                <div className="absolute inset-0 bg-secondary/5 blur-xl"></div>
                <div className="text-2xl font-cyber font-bold text-secondary relative">99.9%</div>
                <div className="text-sm text-muted-foreground relative">Precisão</div>
              </div>
              <div className="text-center relative">
                <div className="absolute inset-0 bg-accent/5 blur-xl"></div>
                <div className="text-2xl font-cyber font-bold text-accent relative">24/7</div>
                <div className="text-sm text-muted-foreground relative">Suporte</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative group">
              ...
              {/* Scanning rings */}
              <div className="absolute inset-0 border-2 border-primary/20 rounded-full animate-ping scale-110"></div>
              <div className="absolute inset-0 border border-secondary/30 rounded-full animate-pulse scale-125"></div>
            ...
            <div className="absolute -top-8 -right-8 w-12 h-12 border-2 border-primary rounded-full animate-ping">
              <div className="absolute inset-2 bg-primary rounded-full animate-pulse"></div>
            </div>
            <div className="absolute -bottom-8 -left-8 w-8 h-8 bg-secondary rounded-full animate-pulse glow-green">
